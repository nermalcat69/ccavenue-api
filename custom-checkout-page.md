...
From your MARS account under Settings tab > API Keys page; copy the merchant ID, access code and secret encryption.
Payment Processing:
Refer to the following code and make necessary changes in your payment page for fetching the payment options JSON object from the CCAvenue server. In the integration kit you will find this code in dataFrom.htm file.
